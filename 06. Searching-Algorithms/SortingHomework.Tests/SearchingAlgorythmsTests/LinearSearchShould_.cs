...
{
    [TestFixture]
    public class LinearSearchShould_
    {
        [Test]
        [TestCase(1)]
        [TestCase(2)]
        ...
        public void ReturnTrue_IfSearchedNumberExistInCollection(int searchedNumber)
        {
            ...
            // Act
            var isFount = sortableCollection.LinearSearch(searchedNumber);
        ...
        public void ReturnTrue_IfSearchedStringExistInCollection(string searchedString)
        {
            ...
            // Act
            var isFount = sortableCollection.LinearSearch(searchedString);
        ...
        public void ReturnFalse_IfPassedCollectionIsEmpty()
        {
            ...
            // Act
            var isFount = sortableCollection.LinearSearch(2);
